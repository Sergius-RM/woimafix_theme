...
class ElCheck
{
     ...
     * @var string
     */
    protected $wpIndeedUrlEndpoint  = 'https://wpindeed.com/wp-content/plugins/wpindeed-envato/input.php'; // wpIndeed Server
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected $wpIndeedRevokeEndpoint = 'https://wpindeed.com/wp-admin/admin-ajax.php';
    /**
     * @var string
     */
    ...
    public function ajax()
    {
        ...
        echo esc_ump_content($this->getRedirectLinkToWpIndeed( sanitize_text_field( $_POST['s'] ) ));
        die;
    }
