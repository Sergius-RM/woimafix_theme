...
class Wizard
{
    ...
    public function styleAndScripts()
    {
          ...
          wp_enqueue_script( 'iump-wizard', IHC_URL . 'admin/assets/js/wizard.js', [ 'jquery' ], 12.1 );
          wp_enqueue_style( 'iump-wizard-style', IHC_URL . 'admin/assets/css/wizard.css', [], 12.1 );
    }
